...
func TestAzureClusterUpdateMutate(t *testing.T) {
	...
	testCases := []testCase{
		{
			...
			cluster: builder.BuildAzureCluster(builder.Name("ab123"), builder.Labels(map[string]string{"release.giantswarm.io/version": "v13.1.0", "azure-operator.giantswarm.io/version": "4.2.0", "cluster-operator.giantswarm.io/version": "0.23.11"})),
			patches: []mutator.PatchOperation{
				{
					Operation: "add",
		...
		},
		{
			...
			cluster: builder.BuildAzureCluster(builder.Name("ab123"), builder.Labels(map[string]string{"release.giantswarm.io/version": "v13.1.0", "azure-operator.giantswarm.io/version": "5.1.0", "cluster-operator.giantswarm.io/version": "0.23.10"})),
			patches: []mutator.PatchOperation{
				{
					Operation: "add",
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			patches, err := admit.MutateUpdate(context.Background(), nil, tc.cluster)
